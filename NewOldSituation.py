...
#####write xlwt
    ...
    def runwrite(self):
        ...
        self.xls_writetwo_dict(self.sheet,'olduserlostratio',self.viplist,self.datelist,self.totaldict)
        self.xls_writetwo_dict(self.sheet, 'olduseractive', self.viplist, self.datelist, self.peopledict,25,0)
        self.pay_ratio()
        self.sheetadd('sheet2')
        self.xls_writetwo_dict(self.sheet,'olduserpayratio',self.viplist,self.datelist,self.paydict)
        self.xls_writetwo_dict(self.sheet, 'olduserpaymoney', self.viplist, self.datelist, self.moneydict,25,0)
        self.new_lostratio()
        self.sheetadd('sheet3')
        self.xls_writeone_list(self.sheet,'newuserlostratio',self.datelist,self.newnumdict)
        ...
        self.itembuy('2018-09-01','2018-09-24')
        self.xls_writetwo_dict(self.sheet,'itembuyratio0901-0924',self.itemlist,self.viplist,self.itembuyratio,0,26)
        self.xls_writetwo_dict(self.sheet, 'itemavg0901-0924', self.itemlist, self.viplist, self.itemavgtimes,25,26)
        self.xls_writetwo_dict(self.sheet, 'itembuypeople0901-0924', self.itemlist, self.viplist, self.itembuypeople, 50, 26)
        self.xls_writetwo_dict(self.sheet, 'activepeople0901-0924', self.itemlist, self.viplist, self.activepeople, 75, 26)
...
###newuser
    ...
    # | 30 | 3 | 22 | 22 | 692 | 0.0318 | 1.0000 |
    # | 31 | 3 | 1 | 1 | 692 | 0.0014 | 1.0000 |
    # | 32 | 3 | 6 | 6 | 692 | 0.0087 | 1.0000 |
    # | 33 | 3 | 28 | 28 | 692 | 0.0405 | 1.0000 |
    # | 47 | 3 | 12 | 34 | 692 | 0.0173 | 2.8333 |
    # | 48 | 3 | 10 | 15 | 692 | 0.0145 | 1.5000 |
        if alldata:
            for rec in alldata:
